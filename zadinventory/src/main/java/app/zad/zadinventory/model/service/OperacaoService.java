...
public class OperacaoService {
    ...
    public OperacaoEntity atualizar(Long id, OperacaoEntity operacaoAtualizada) {
        ...
        if (operacaoAtualizada.getProduto() != null && operacaoAtualizada.getProduto().getId() != null) {
            ...
            operacaoExistente.setProduto(novoProduto); // CORREÇÃO: era 'produto', agora 'novoProduto'
        }
        ...
        if (operacaoAtualizada.getDiaOperacao() != null) {
            operacaoExistente.setDiaOperacao(operacaoAtualizada.getDiaOperacao());
        }
        if (operacaoAtualizada.getQuantidade() != null) {
            operacaoExistente.setQuantidade(operacaoAtualizada.getQuantidade());
        }
        if (operacaoAtualizada.getValorTotal() != null) {
            operacaoExistente.setValorTotal(operacaoAtualizada.getValorTotal());
        }
